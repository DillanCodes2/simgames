...
class Simulation:
   class Simulation:
    ...
    def handle_property_logic(self, player: Player, space: Space, strategy: str) -> str:
        """Buy or pay rent based on strategy. Returns OK or BANKRUPT."""
        # Buying logic
    ...
    def handle_housing_logic(self, player: Player, strategy: str) -> None:
        """Called end of turn to decide building (simplified rules)."""
    ...
    def run_full_game(self, max_turns: int = 1000) -> Tuple[str, List[Tuple[str, int, int]]]:
        ...
        Returns (winner_strategy, results_list).
        """
...
def run_batch(iterations: int, strategies: List[str], max_turns: int = 1000,
    ...
    for _ in range(iterations):
        ...
        sim = Simulation(strategies, seed=game_seed)
